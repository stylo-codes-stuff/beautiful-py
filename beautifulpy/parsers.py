...
javascript = Lark.open("beautifulpy/grammars/javascript.lark",start="file_input", parser="lalr")
...
mini_js = Lark.open("beautifulpy/grammars/javascript_mincode.lark",start="file_input",parser="lalr")
