...
#note to self to find a way to remove imports that are from libraries as 
...
print(get_requirements("tests/python_test.py","python",filter_builtins=False))
if "itertools" in sys.stdlib_module_names:
    print("yes")
